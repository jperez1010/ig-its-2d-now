...
== MythMaster ==
    ...
    - Welp, that's a nice goal and all but so long as were stuck down here, the only thing I see us becoming is a plaything for a wild morph. 
    * Well, how did you get in here in the first place?
    ...
    - Unfortunately, I was chased out by a swarm of mythomorphs that must have been caused by your little cave-in.
    ...
    * Well, it would be a bit hard to be a myth master and all without one.
    - ... 
    - Alright. If I'm able to get us to where I dropped my mythogem, I can use my morphs to guide us to the ruins entrance.
